...
def local_action_probabilities(p_transition, all_features):
...
def irl(p_transition, features, all_states, optim, init, eps=1e-4, eps_esvf=1e-5):
...
if __name__ == "__main__":
    ...
    print(local)
    #reward = irl(p_transition, all_states, all_trajectory, optim, init, eps=1e-4, eps_esvf=1e-5)
    #print(feature_expectation[1])
